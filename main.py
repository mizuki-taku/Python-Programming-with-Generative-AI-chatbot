...
# フォルダのパス
lecture_folder = "./Python-Programming-with-Generative-AI"  # 講義資料フォルダ
example_folder = "./Python-Programming-with-Generative-AI-example"     # 回答例フォルダ
log_folder = "./logs"             # 会話ログ保存フォルダ"./logs"
